...
const PaymentsPage = () => {
  ...
  <button
    ...
    className="w-full sm:w-auto px-4 py-2 rounded-lg text-xs font-semibold text-white hover:opacity-90 transition-all"
    style={{
  ...
  {(appliedFromDate || appliedToDate) && (
    <button
      ...
      className="w-full sm:w-auto px-4 py-2 rounded-lg text-xs font-semibold border border-border text-card-foreground hover:bg-secondary transition-colors"
    >
      Reset
    </button>
  )}
      ...
      <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div className="bg-green-50 rounded-xl p-4 border border-green-200">
            ...
            <p className="text-2xl font-bold text-green-900">₹{stats.totalRevenue.toLocaleString()}.00</p>
          </div>
          ...
          <div className="bg-red-50 rounded-xl p-4 border border-red-200">
            <div className="flex items-center gap-2 mb-2">
              ...
              <p className="text-xs font-medium text-red-700">To Be Collect From</p>
            </div>
            <p className="text-2xl font-bold text-red-900">{stats.toCollect}</p>
          </div>
        </div>
      </div>
